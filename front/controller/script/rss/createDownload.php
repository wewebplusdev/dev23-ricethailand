...
$data2 ="";
  ...
  $urlrelative = $valImgNewsDb;
	...
	/* ###### End Img ##############*/
	  ...
	  if($value[11]=='file'){
	  $valDownloadFunc = fileinclude($value[13],'file',$value[1],'download');
	   $link = $linkRSSDetail.'/'. $valDownloadFunc."&amp;n=". $value[8]."&amp;t=".encodeStr('md_dwn')."";
	  }else{
	  	$link = $value[12];
	  }
