                    ...
                    <div class="row row-0">
                        ...
                        <div class="col-auto">
                            <div class="filter-box" data-aos="fade-up">
                                <a href="javascript:void(0)" class="link filter-search">
                ...
                <div class="container">
                    <div class="head-detail">
                        ...
                        <div class="tag-list" data-aos="fade-up">
                            <ul class="item-list">
                                {foreach $callDataTag as $keycallDataTag => $valuecallDataTag}
                                    <li>
                                        <a href="{$ul}/search?tag={$valuecallDataTag.id}" class="link">#{$valuecallDataTag.subject}</a>
                                    </li>
                                {/foreach}
                            </ul>
                        </div>
