...
switch ($url->segment[2]) {
    case 'detail':
        ...
        $listjs[] = '<script type="text/javascript" src="'._URL.'front/controller/script/'.$menuActive.'/js/scriptDetail2.js"></script>';
    ...
    default:
		...
		$datacallNewsUnitRows =callNewsUnitRows();
		$smarty->assign("datacallNewsUnitRows", $datacallNewsUnitRows);
		
		$dataNewsYearRows =callNewsYearRows();
		$smarty->assign("dataNewsYearRows", $dataNewsYearRows);
