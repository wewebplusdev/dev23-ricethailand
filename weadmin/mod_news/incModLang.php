...
$langMod["tit:inpName"] = "Name " .getNameMenu($_REQUEST["menukeyid"]);
		...
		$langMod["txt:picTg"] = "รูปภาพ Top Graphic";
		...
		$langMod["inp:notefile"] ="หมายเหตุ : กรุณาอัพโหลดเฉพาะไฟล์ |weweb_file| เท่านั้น และขนาดไฟล์ไม่เกิน 100 Mb";
		...
		$langMod["tit:uploadvdonote"] ="หมายเหตุ : กรุณาอัพโหลดเฉพาะไฟล์ |weweb_video| เท่านั้น และขนาดไฟล์ไม่เกิน 100 Mb";
		$langMod["tit:noteg"] ="หมายเหตุ";
		$langMod["tit:selectg"] ="เลือกประเภท".getNameMenu($_REQUEST["menukeyid"]);
		...
		$langMod["tit:viewconf"]="จำนวนผู้เข้าชม";
			...
			$langMod["tit:selecttag"] = "แท็กเชื่อมโยง";
			$langMod["tit:selectma"] = "แผนการจัดการความรู้";
			$langMod["tit:selectag"] = "หน่วยงาน";
			$langMod["tit:setting"] = "ตั้งค่า";
			$langMod["tit:Plan"] = "แสดงแผนการจัดการความรู้";
			$langMod["tit:groupnews"] = "กลุ่มองค์ความรู้";
			$langMod["tit:selectg"] = "เลือก".$langMod["tit:groupnews"];
			$langMod["tit:selectgtag"] = "เลือกแท็กเชื่อมโยง";
			$langMod["tit:appby"] = "อนุมัติโดย";
			$langMod["tit:appdate"] = "วันที่อนุมัติ";
			$langMod["tit:groupnews"] = "กลุ่มองค์ความรู้";
			$langMod["tit:year"] = "ปีงบประมาณ";
			$langMod["tit:selectyear"] = "เลือก".$langMod["tit:year"];
			$langMod["meu:group"] = "กลุ่มองค์ความรู้";
			$langMod["tit:subjectg"] = "ชื่อ".$langMod["meu:group"];
			$langMod["txt:titleaddg"] = "สร้างข้อมูล".$langMod["meu:group"];
			$langMod["txt:subjectg"] = "ข้อมูล".$langMod["meu:group"];
			$langMod["txt:subjectgDe"] = "โปรดป้อนชื่อ".$langMod["meu:group"]." เพื่อใช้ในการแสดงผลในหน้าเว็บไซต์ของคุณ";
			...
			$langMod["dev0821:color"] = "เลือกปีงบประมาณ";
			$langMod["dev0821:per"] = "ครั้งที่";
			$langMod["dev0821:kmaction"] = "KM Action Plan";
			$langMod["dev0821:kmactionSel"] = "เลือก KM Action Plan";
			$langMod["export:no"] = "ลำดับ";
			$langMod["dev0821:tag"] = "ข้อมูลแท็กเชื่อมโยง";
			$langMod["dev0821:tagDe"] = "ข้อมูลนี้คือส่วนที่ใช้ในการกำหนดแท็กเชื่อมโยงในการแสดงผลส่วนนี้ เพื่อใช้ในการแสดงผลในหน้าเว็บไซต์ของคุณ";
}
?>
