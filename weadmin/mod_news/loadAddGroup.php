    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <label>
              <div class="formDivRadioL"><input name="inputTypePlan" id="inputTypePlan" value="1" type="radio" class="formRadioContantTb" /></div>
              <div class="formDivRadioR"><?php echo  $modTxtShowPic[1] ?></div>
            </label>

            <label>
              <div class="formDivRadioL"><input name="inputTypePlan" id="inputTypePlan" value="2" type="radio" class="formRadioContantTb" checked="checked" /></div>
