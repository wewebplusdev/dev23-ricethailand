...
$sqlMaxOrder .= "  AND " . $mod_tb_root . "_groupProoject ='" . $_REQUEST['inputGh'] . "'  ";
        ...
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt">
            ...
            if($_REQUEST['inputGh31']>=1) {
              $sql = $sql."  AND ".$mod_tb_root."_yearid ='".$_REQUEST['inputGh31']."'   ";
            }
            if($_REQUEST['inputGh2']>=1) {
              $sql = $sql."  AND ".$mod_tb_root."_agenid = '".$_REQUEST['inputGh2']."'   ";
            }
