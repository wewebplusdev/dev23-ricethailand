...
$sql .= " ," . $mod_tb_root_group . "_coreid,  " . $mod_tb_root_group . "_col,  " . $mod_tb_root_group . "_pic, " . $mod_tb_root_group . "_agenid," . $mod_tb_root_group . "_typeplan";
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <!-- <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputColor" id="inputColor" type="text" class="izzyColor" value="<?php echo  $oror ?>" style="border: 1px solid <?php echo  $valColor ?>;" /></td>
        </tr> -->
        <tr>
        ...
        <tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php echo  $langMod["tit:Plan"] ?></td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <label>
              <div class="formDivRadioL"><input name="inputTypePlan" id="inputTypePlan" value="1" type="radio" class="formRadioContantTb" <?php if ($valPlan != 2) { ?> checked="checked" <?php  } ?> />
              </div>
              <div class="formDivRadioR"><?php echo  $modTxtShowPic[1] ?></div>
            </label>

            <label>
              <div class="formDivRadioL"><input name="inputTypePlan" id="inputTypePlan" value="2" type="radio" class="formRadioContantTb" <?php if ($valPlan == 2) { ?> checked="checked" <?php  } ?> />
              </div>
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?php echo  $langMod["txt:colorDe"] ?></span>
          </td>
        </tr>
        <tr>
          <td colspan="7" align="right" valign="top" height="15"></td>
