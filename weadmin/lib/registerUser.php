...
function sendEmail(){
    ...
    $urlVerify = $_SERVER['HTTP_HOST']."/".$getpathCoreWeadmin."/verifyEmail.php?token=".$member_verify_code."";
    // set up form
                    ...
                    <td class='wrapper'>
                      <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td>
                            <p>สวัสดี</p>
                            <p>การสมัครสมาชิกของคุณจะเสร็จสิ้น หลังจากยืนยันอีเมลของคุณจะทำให้สามารถเข้าใช้งานระบบได้อย่างสมบูรณ์ และการแจ้งเตือนทั้งหมดในอนาคตจะถูกส่งไปยังที่อยู่อีเมลนี้.</p>
