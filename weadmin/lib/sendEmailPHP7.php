...
require str_replace("\\", '/', dirname(__FILE__)) . '/vendor/autoload.php'; #load Ribary
...
// $clientSecret = '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'; //ClienSecret ที่ได้จาก Google console
// // $refreshToken = '1//0gNIzPRHn7kPDCgYIARAAGBASNwF-L9IrOe0SIyIEErzf-zsK5ftX9l1gn8HAXjMFoWZLvzHIdzUALco4RlrB7tgfqK1J6DhHYMA'; // refresgToken
// $refreshToken = '1//0gG4Zm9kl_-O1CgYIARAAGBASNwF-L9Ir7uDC1RL1_d0iVW6kWH4E2jzOhD72T4gb-W1EcZ8sOv7RVF9qCnTyEVlKUHQjlv0Mqak'; // refresgToken
$provider = new Google(
[
    'clientId' => $clientId,
