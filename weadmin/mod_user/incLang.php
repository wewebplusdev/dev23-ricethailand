...
พร้อมทั้งยังสามารถเปิดแสดงผลเนื้อหาได้ทันทีโดยตัวคุณเอง";
    ...
    $langTxt["us:titlesystem"] = "ข้อมูลเบื้องต้นผู้ใช้งานระบบ";
    $langTxt["us:titlesystemDe"] = "โปรดป้อนข้อมูลเบื้องต้นผู้ใช้งานระบบ เพื่อใช้ในการควบคุมผู้ใช้งานระบบในการจัดการเว็บไซต์ของคุณ";
...
$langTxt["txt:year"] = "ปี";
$langTxt["txt:year:se"] = "เลือกปี";
$langTxt["txt:county"] = "สำนักงาน";
$langTxt["txt:county:se"] = "เลือกสำนักงาน";
$langTxt["txt:province"] = "จังหวัด";
$langTxt["txt:province:se"] = "เลือกจังหวัด";
$langTxt["txt:district"] = "อำเภอ/เขต";
$langTxt["txt:district:se"] = "เลือกอำเภอ/เขต";
$langTxt["txt:subdistrict"] = "ตำบล/แขวง";
$langTxt["txt:subdistrict:se"] = "เลือกตำบล/แขวง";
$langTxt["txt:value:ave"] = "จำนวน";
...
$langTxt["us:logindate"] = "วันที่เข้าสู่ระบบล่าสุด";
}
?>
