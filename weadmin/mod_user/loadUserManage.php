                                  ...
                                  <tr>
                                    ...
                                    <td align="left">
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    <td align="right">
                                                        <div  class="btnAdd" title="<?php   echo $langTxt["btn:add"]?>" onclick="addContactNew('./addUs.php');"></div>
...
if($count_record>0) {
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?php   echo $valID?>;  
    viewContactNew('./viewUs.php');" ><?php   echo $valName?></a></td>
  </tr>
</table>    </td>
...
<a href="javascript:void(0)"  onclick="changeStatus('load_waiting<?php   echo $valID?>','<?php   echo $core_tb_staff?>','<?php   echo $valStatus?>','<?php   echo $valID?>','load_status<?php   echo $valID?>','./statusMg.php')" ><span class="<?php   echo $valStatusClass?>"><?php   echo $valStatus?></span></a>
