...
include("incLang.php");
$langTxt = getRreplaceForView($langTxt);

$valClassNav = 2;
$valNav1 = $langTxt["nav:home2"];
$valLinkNav1 = "./index.php";
...
$sql = "SELECT 
		...
		" . $core_tb_staff . "_logdate as lonindate
...
$valLonindate = DateFormat($Row['lonindate']);
  ...
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <div class="divRightNav">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php  echo  $valLinkNav1 ?>" target="_self"><?php  echo  $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('./index.php')" target="_self"><?php  echo  $valNav2 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php  echo  $langTxt["us:viewpermis"] ?></span></td>
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php  echo  $langTxt["us:agency"] ?>:</td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView"><?php 
                                      $sql_groupAg = "SELECT " . $md_group_tb . "_id," . $md_group_tb . "_subject  FROM " . $md_group_tb . " WHERE " . $md_group_tb . "_id='" . $valIdAgency . "'   ORDER BY " . $md_group_tb . "_order DESC ";
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          ...
          <tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php  echo  $langTxt["us:logindate"] ?>:</td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView"><?php  echo  $valLonindate ?></div>
          </td>
        </tr>
