    ...
    <form action="?" method="post" name="myForm" id="myForm">
        ...
        <div class="divRightMain">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                <tr>
                    <td align="left" valign="middle" class="divRightTitleTbL" style="height:30px; padding-left:10px;"><span class="fontTitlTbRight"><?php echo $langTxt["mg:subject"] ?></span></td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td align="left" style="padding-top:3px; padding-left:10px;">
                                            <div class="widthDiv">
                                                <span class="fontContantTbupdate"><?php echo  $valSubject ?></span>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
