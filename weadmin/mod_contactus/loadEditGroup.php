    ...
    if(isBlank(inputEmail)) {
      ...
      if(!isBlank(inputEmail)){
        if (!isEmail(inputEmail.value)) {
          ...
          //insertContactNew('insertEmailGroup.php');
        modInsertEmail('insertEmailGroup.php');
  }
...
<form action="?" method="get" name="myForm" id="myForm">
  ...
  <tr >
    ...
    <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                    <tr >
                        <td colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
    <span class="formFontSubjectTxt">แก้ไขอีเมลล์<?php //=$langMod["txt:set"]?></span><br/>
    ...
    <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
          <?php 
$sql = "SELECT ".$mod_tb_root_email."_email,".$mod_tb_root_email."_id FROM ".$mod_tb_root_email." WHERE ". $mod_tb_root_email . "_gid='" . $valid . "'  
and ".$mod_tb_root_email."_key='".$_REQUEST['masterkey']."' ORDER BY ".$mod_tb_root_email."_id ASC ";
$query=wewebQueryDB($coreLanguageSQL,$sql);
...
?>
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php  echo number_format($num_email)?>.
  ...
  <a href="javascript:void(0)"  onclick="document.myForm.valDelFile.value=<?php  echo $valEmailID?>; modDelEmail('deleteEmailGroup.php')" ><img src="../img/btn/delete.png" align="absmiddle" title="Delete email"  hspace="5"     border="0" /></a> <?php  echo $valEmailNew?></div></td>
  </tr>
...
<?php  }} ?>
  ...
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" style="padding-top:10px;" ><?php  echo  $langMod["tit:email1"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
