...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
          <?php 
$sql = "SELECT ".$mod_tb_root_email."_email,".$mod_tb_root_email."_id FROM ".$mod_tb_root_email."  WHERE  ".$mod_tb_root_email."_gid='".$_REQUEST['valEditID']."' and ".$mod_tb_root_email."_key ='".$_REQUEST["masterkey"]."' ORDER BY ".$mod_tb_root_email."_id ASC ";
$query=wewebQueryDB($coreLanguageSQL,$sql);
