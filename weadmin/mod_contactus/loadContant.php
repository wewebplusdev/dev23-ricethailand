...
if($inputSearch<>"") {
  $sql_export = $sql_export."  AND   ( ".$mod_tb_root."_subject LIKE '%$inputSearch%'  OR  ".$mod_tb_root."_message LIKE '%$inputSearch%' OR ".$mod_tb_root."_name LIKE '%$inputSearch%'   ) ";
}


if($inputGh>=1) {
  $sql_export = $sql_export."  AND    ".$mod_tb_root."_gid='".$inputGh."'  ";
}
...
<tr >
  ...
  <td width="20%"     valign="middle"  class="divRightTitleTb" ><span class="fontTitlTbRight"><?php  echo $langMod["tit:name"]?><?php  if($_SESSION[$valSiteManage.'core_session_languageT']==2){?>(<?php  echo $langTxt["lg:thai"]?>)<?php  } ?></span></td>

  <td align="center"   valign="middle"  class="divRightTitleTb" ><span class="fontTitlTbRight"><?php  echo $langMod["tit:subject_table"]?><?php  if($_SESSION[$valSiteManage.'core_session_languageT']==2){?>(<?php  echo $langTxt["lg:thai"]?>)<?php  } ?></span></td>
...
// $sql = $sql."  WHERE ".$mod_tb_root."_masterkey ='".$_REQUEST['masterkey']."'  AND  ".$mod_tb_root."_language   ='".$_SESSION[$valSiteManage.'_session_language']."'";
...
if($inputSearch<>"") {
		$sql = $sql."  AND  (
		".$mod_tb_root."_subject LIKE '%$inputSearch%'  OR  ".$mod_tb_root."_message LIKE '%$inputSearch%'  OR ".$mod_tb_root."_name LIKE '%$inputSearch%'   ) ";
}
...
if($count_record>0) {
  ...
  <tr>
     <!-- <td width="39" align="left" valign="top">
        <img src="../img/user/tel.jpg"   width="20" height="20" align="absmiddle" border="0" />   
      </td> -->
