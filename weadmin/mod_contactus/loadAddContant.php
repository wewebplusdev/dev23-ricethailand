                                    ...
                                    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                        <label>
                                            <div class="formDivRadioL">
                                                <input name="playset" id="playset" value="1" type="radio"  class="formRadioContantTb" /></div>
                                            <div class="formDivRadioR"><?php  echo  $langMod["tit:playauto"] ?></div>
                                        </label>

                                        <label>
                                            <div class="formDivRadioL"><input name="playset" id="playset"  value="0"  type="radio"  class="formRadioContantTb" checked="checked"  /></div>
