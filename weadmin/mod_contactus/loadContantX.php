...
if($inputgroupID>=1) {
  $sql_export = $sql_export."  AND    ".$mod_tb_root."_gid='".$inputgroupID."'  ";
}
...
<input name="module_orderby" type="hidden" id="module_orderby" value="<?php  echo $module_orderby?>" />
    ...
    <select name="inputGh"  id="inputGh" onchange="document.myForm.submit();" class="formSelectSearchStyle" >
       <option value="0"><?php  echo $langMod["op:selectg"]?> </option>
        <?php 
	$sql_group = "SELECT ".$mod_tb_root_group."_id,".$mod_tb_root_group."_subject
    FROM ".$mod_tb_root_group." WHERE  ".$mod_tb_root_group."_masterkey ='".$_REQUEST['masterkey']."'   ORDER BY ".$mod_tb_root_group."_order DESC ";
  ...
  <input name="inputSearch" type="text"  id="inputSearch" value="<?php  echo trim($_REQUEST['inputSearch'])?>" class="formInputSearchStyle"  placeholder="<?php  echo $langTxt["sch:search"]?>" /></td>
          <td style="padding-right:10px;" align="right" width="5%"><input name="searchOk" id="searchOk" onClick="document.myForm.submit();"  
            type="button" class="btnSearch"  value=" "  /></td>
    </tr>
</table>
...
<div class="divRightHead" >
                  ...
                  "></div>
                                                        ...
                                                        <!-- <div  class="btnExportPdf" title="<?php  echo  $langTxt["btn:export"] ?>" onclick="
                                                                document.myFormExport.action = 'exportReport_pdf.php';
                                                                document.myFormExport.submit();
                                                              "></div> -->
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center"   class="tbBoxListwBorder">
   <tr ><td width="3%"  class="divRightTitleTbL"  valign="middle" align="center" >
     ...
     <td width="20%"     valign="middle"  class="divRightTitleTb" ><span class="fontTitlTbRight"><?php  echo $langMod["tit:subject"]?><?php  if($_SESSION[$valSiteManage.'core_session_languageT']==2){?>(<?php  echo $langTxt["lg:thai"]?>)<?php  } ?></span></td>

     <td align="center"   valign="middle"  class="divRightTitleTb" ><span class="fontTitlTbRight"><?php  echo $langMod["tit:subject"]?><?php  if($_SESSION[$valSiteManage.'core_session_languageT']==2){?>(<?php  echo $langTxt["lg:thai"]?>)<?php  } ?></span></td>
    ...
    <!-- <td width="12%"  class="divRightTitleTb"  valign="middle"  align="center"><span class="fontTitlTbRight"><?php  echo $langTxt["mg:highlight"]?></span></td> -->
...
FROM ".$mod_tb_root;
$sql = $sql."  WHERE ".$mod_tb_root."_masterkey ='".$_REQUEST['masterkey']."'  AND  ".$mod_tb_root."_language   ='".$_SESSION['dmcr_core_session_language']."'";
...
$sql = $sql."ORDER BY ".$mod_tb_root."_id DESC   ";
...
if($count_record>0) {
  ...
  <tr>
    ...
    <img src="../img/user/tel.jpg"   width="20" height="20" align="absmiddle" border="0" />    </td>
    <td align="left" style="padding-left:10px; " valign="top">
		 	 <div class="widthDiv">
			<?php  echo $valName?></a></div>
  </td>
  </tr>
</table></td>
...
<td  class="divRightContantOverTb"   valign="top" align="left" >
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?php  echo $valID?>;
    viewContactNew('viewContant.php');" ><?php  echo $valSuject?></a>
</td>
  </tr>
</table></td>
     ...
     <td  class="divRightContantOverTb"  valign="top"  align="center">
               ...
               <img src="../img/icon/enable.png" alt="Enable" align="absmiddle" hspace="10" border="0" />
                   <span class="<?php  echo $valStatusClass?>"><?php  echo $valStatus?></span>
                <?php  }else{?>
                <img src="../img/icon/disable.png" alt="Enable" align="absmiddle" hspace="10" border="0" />
                    <span class="<?php  echo $valStatusClass?>"><?php  echo $valStatus?></span>
                <?php  } ?>

           </td>

           <!-- <td style="display:show;"  class="divRightContantOverTb"  valign="top"  align="center">
       <?php  if($valPermission=="RW" ){?>
