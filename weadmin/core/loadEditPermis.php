...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
  ...
  <td  class="divRightContantOverTbL"  valign="top" align="left"  style="padding-left:15px;">
     <?php if($topic1[$Field."_icontype"] == 1  || $topic1[$Field."_icontype"] == ""){ ?>
     ...
     <?php }else{ ?>
          <span class="feather <?php echo $topic1[$Field."_classname"] ?>" hspace="10"></span> <?php echo $row_namelv1?>
        <?php } ?>
    </td>
  ...
  <?php
            ...
            <?php if($subtopic1[$Field."_icontype"] == 1  || $subtopic1[$Field."_icontype"] == ""){ ?>
     ...
     <?php }else{ ?>
          <span class="feather <?php echo $subtopic1[$Field."_classname"] ?>" hspace="10"></span> <?php echo $row_namelv2?>
        <?php } ?>
    </td>
    </td>
