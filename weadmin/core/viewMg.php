...
?>
  ...
  <tr >
    ...
    <?php if($valType == 1  || $valType == ""){ ?>
      <img src="<?php echo $valIcon?>" name="LibraryIconSample" id="LibraryIconSample" onerror="this.src='<?php echo "../img/btn/blank.gif"?>'"   />
      <?php } else { ?>
        <span class="feather <?php echo $valClassname ?>"></span>
        <?php } ?>
    </div> </td>
  </tr>
          <tr>
