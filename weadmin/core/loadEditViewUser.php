...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputTypeUser" id="inputTypeUser" type="hidden" class="formRadioContantTb" value="<?php  echo $valUsertype?>" />
    
					<div class="divRightNav">
                        <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php   echo $valLinkNav1?>" target="_self"><?php   echo $valNav1?></a>  <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php   echo $langTxt["us:editpermis"]?></span></td>
