...
if($_REQUEST['inputGh']>=1){
	$sqlSearch = $sqlSearch."  AND    ".$core_tb_staff."_groupid='".$_REQUEST['inputGh']."'  ";
                ...
                if ($inputSearch <> "") {
                        ...
                        foreach ($strSearch as $txtSearch) {
                            $paraTxt = array();
                            $paraTxt[] = " " . $core_tb_staff . "_fnamethai LIKE '%$txtSearch%' ";
                            $paraTxt[] = " " . $core_tb_staff . "_lnamethai LIKE '%$txtSearch%' ";
							$paraTxt[] = " " . $core_tb_staff . "_fnameeng LIKE '%$txtSearch%' ";
                            $paraTxt[] = " " . $core_tb_staff . "_lnameeng LIKE '%$txtSearch%' ";
                            $paraTxt[] = " " . $core_tb_staff . "_email LIKE '%$txtSearch%' ";
                            $paraTxt[] = " " . $core_tb_staff . "_username LIKE '%$txtSearch%' ";
                            $listTxt[] = "(" . implode(" or ", $paraTxt) . ")";
                        }

                        $sqlSearch .= " AND  ".implode(" or ", $listTxt);
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
   <tr ><td width="3%"  class="divRightTitleTbL"  valign="middle" align="center" >
    ...
    <td width="12%"  class="divRightTitleTb"  valign="middle"  align="center"><span class="fontTitlTbRight">ประเภทผู้ใช้</span></td>
    <td width="12%"  class="divRightTitleTb"  valign="middle"  align="center"><span class="fontTitlTbRight"><?php echo $langTxt["nav:perManage2"]?></span></td>
...
if($count_record>0) {
  ...
  $sql_group = "SELECT ".$core_tb_group."_id,".$core_tb_group."_name  FROM ".$core_tb_group." WHERE ".$core_tb_group."_id='".$valGroupID."' ";
    $query_group=wewebQueryDB($coreLanguageSQL,$sql_group);
...
<td  class="divRightContantOverTb"  valign="top"  align="center">
    <span class="fontContantTbupdate">
      <? if ($valUesrType == 2){ ?>
    <?php echo $arrTypeUser[2] ?>
    <?}else{?>
      <?php echo $arrTypeUser[1] ?>
    <?}?>
      
    </span>   </td>
<td  class="divRightContantOverTb"  valign="top"  align="center">
    <span class="fontContantTbupdate"><?php echo $row_groupname?></span>   </td>
<td  class="divRightContantOverTb"  valign="top"  align="center">
