...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <tr id="icon-class" style="display:none;"  >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langTxt["mg:inpiconclass"]?></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
       
            <input name="inputClassIcon" id="inputClassIcon" type="text" class="formInputContantTb" placeholder="<?php echo $langTxt["mg:inpiconclass"]; ?>" value="<?php echo $valClassName; ?>" />
