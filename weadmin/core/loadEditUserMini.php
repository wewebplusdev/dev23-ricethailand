...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="valUserMain" type="hidden" id="valUserMain" value="<?php   echo $_SESSION[$valSiteManage."core_session_id"]?>" />
					...
					<div class="divRightNav">
                        ...
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php   echo $valLinkNav1?>" target="_self"><?php   echo $valNav1?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('../core/userMiniManage.php')" target="_self"><?php   echo $valNav2?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php   echo $langTxt["us:editpermis"]?></span></td>
  ...
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
     <input name="inputgroupid" type="hidden" id="inputgroupid" value="<?php   echo $valMiniPermissionUser?>" /></td>
  </tr>
