  ...
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <div class="divRightNav">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php  echo  $valLinkNav1 ?>" target="_self"><?php  echo  $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('../core/userManage.php')" target="_self"><?php  echo  $valNav2 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php  echo  $langTxt["us:crepermis"] ?></span></td>
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr class="typePrivate" <?php  if ($_REQUEST['inputUT'] == 2) { ?> style="display:none;" <?php   } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputPassword" id="inputPassword" type="password" class="formInputContantTbShot" /><br />
<span class="formFontNoteTxt"><?php  echo  $langTxt["note:password"] ?></span></td>
        </tr>
        <tr class="typePrivate" <?php  if ($_REQUEST['inputUT'] == 2) { ?> style="display:none;" <?php   } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputPassword1" id="inputPassword1" type="password" class="formInputContantTbShot" /><br />
<span class="formFontNoteTxt"><?php  echo  $langTxt["note:password"] ?></span></td>
        </tr>
      </table>
      <br />
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <select name="inputgroupAgency" id="inputgroupAgency" class="formSelectContantTb">
