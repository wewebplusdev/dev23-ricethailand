    ...
    <form action="?" method="get" name="myForm" id="myForm" enctype="multipart/form-data">
        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                ...
                <tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <select name="inputGroup" id="inputIndustry" class="formSelectContantTb">
                            ...
                            ?>
                                <option value="<?php  echo  $value[0] ?>" <?php   if ($_REQUEST['inputGh'] == $value[0]) { ?>selected<?php  } ?>><?php  echo  $value[3] ?></option>
                            <?php  } ?>
                        </select>
                    </td>
                </tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        ...
                        <label>
                            <div class="formDivRadioL">
                                <input name="inputShowpic" id="inputShowpic" value="1" class="formRadioContantTb" type="radio" checked="checked" />
                            </div>
                            <div class="formDivRadioR">แสดงรูปภาพ</div>
                        </label>

                        <label>
                            <div class="formDivRadioL"><input name="inputShowpic" id="inputShowpic" value="2" class="formRadioContantTb" type="radio" /></div>
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder " style="display:none;">
                ...
                <!-- <tr id="boxInputlinkdesc"   style="display:none;" >
                                        <td width="18%" align="right"  valign="top"  class="formLeftContantTb" >หมายเหตุ <span class="fontContantAlert"></span></span></td>
                                        <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><textarea name="inputurlcdesc" id="inputurlcdesc" cols="45" rows="5" class="formTextareaContantTb"><?php   echo $valUrlC ?></textarea><br />
