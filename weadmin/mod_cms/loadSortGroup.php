...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputSort" type="hidden" id="inputSort" value="" />
					...
					<div class="divRightNav">
                        ...
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php   echo $valLinkNav1?>" target="_self"><?php   echo $valNav1?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('index.php')" target="_self"><?php   echo getNameMenu($_REQUEST["menukeyid"])?></a><img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('group.php')" target="_self">กลุ่มข้อมูลประเมิน</a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" />จัดเรียงข้อมูลกลุ่มข้อมูลประเมิน</span></td>
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight">จัดเรียงข้อมูลกลุ่มข้อมูลประเมิน</span></td>
                                    <td align="left">
